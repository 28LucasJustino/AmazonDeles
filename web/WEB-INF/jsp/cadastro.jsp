                   ...
                   <div class="form">
                       <form action="cad" method="post">
                           ...
                           <div class="cards">
                               ...
                               <div class="inputs">
                                   <label for="telefone"><i class="fa-solid fa-phone" id="icon"></i> Telefone</label>
                           ...
                           <div class="gender-inputs">
                               ...
                               <div class="gender-group">
                                   <div class="gender-input">
                                       ...
                                       <label for="female">Feminino</label><i class="fa-solid fa-venus" id="#iconG"></i>
                                   </div>
           
                                   <div class="gender-input">
                                       <input id="male" type="radio" name="gender">
                                       <label for="male">Masculino</label><i class="fa-solid fa-mars" id="#iconG"></i>
                                   </div>
           
                                   <div class="gender-input">
                                       <input id="others" type="radio" name="gender">
                                       <label for="others">Outros</label><i class="fa-solid fa-transgender" id="#iconG"></i>
                                   </div>
           
                                   <div class="gender-input">
                                       <input id="none" type="radio" name="gender">
                                       <label for="none">Prefiro não dizer</label><i class="fa-solid fa-comment-slash" id="#iconG"></i>
                                   </div>
                               </div>
                           </div>
